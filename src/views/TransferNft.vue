<template>
    <div class="panel">
        <div class="title">{{ popup.trans_nft_title }}</div>
        <div class="pay-info">
        ...
        <div class="notice">{{ popup.nft_receive }}: {{ address }}</div>
        ...
        <div class="action-container" v-if="!isCreating">
            ...
            <a-button v-if="!isCommit" type="primary" @click="commit">{{ popup.commit }}</a-button>
            <a-spin v-else/>
        </div>
        <a-spin v-else/>
    </div>
