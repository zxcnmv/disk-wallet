<template>
    <div class="panel-container">
        ...
        <div class="panel">
            <div class="title" v-if="origin">{{ popup.sign_tx_request }}</div>
            ...
            <div class="tx-container">
                ...
                <div class="tx-list" v-if="showPutType==='inputs'">
                    <div class="item" v-for="item in inputInfosShow" :key="item">
                        <div class="info">
                            <span>{{ popup.tx_type }}</span>
                            <span>{{ item.type }}
                    </span>
                        ...
                        <div class="info">
                            ...
                            <span style="font-size: 12px">{{ item.address }}
                                <!--                        <span class="mine-tag" v-if="item.isChange">{{"popup.mine")}}</span>-->
                    </span>
                        </div>
                        <div class="info">
                    <span>
                ...
                <div class="tx-list" v-else>
                    <div class="item" v-for="item in txDetailList" :key="item">
                        <div class="info">
                            <span>{{ popup.tx_type }}</span>
                            <span>{{ item.type }}
                    </span>
                        ...
                        <div class="info">
                            <!--                                        <span class="tag" v-if="item.isChange">{{"popup.change")}}:</span>-->
...
export default {
    ...
    async mounted() {
        this.userAddress = await walletManager.getMainAddress()
