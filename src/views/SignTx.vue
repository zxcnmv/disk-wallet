<template>
    <div class="panel-container">
        ...
        <div class="panel">
            ...
            <div class="tx-list" v-for="txDetail in txDetailList" :key="txDetail">
                <div class="item" v-for="item in txDetail" :key="item">
                    <div class="info">
                        <span>{{ popup.tx_type }}</span>
                        <span>{{ item.type }}</span>
                    </div>
                    <div class="info">
                        <span>{{ popup.receive_address }}</span>
                        <span style="font-size: 12px">{{ item.address }}</span>
                    </div>
                    <div class="info">
                        <span>{{ popup.pay_amount }}</span>
